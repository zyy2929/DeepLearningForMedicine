...
for epoch in range(start_epoch, epochs + 1):
    ...
    valid_loss, valid_acc, valid_preds_list, valid_truelabels_list, valid_probas_list, valid_auc_score = validation(epoch, model, optimizer, valid_criterion, valid_loader, device, multiclass=True)
    ...
    if is_best:
        best_model_file = "best_models/3_googlenet_pretrained_best_model_" + str(epoch) + ".pth"
        torch.save(model.state_dict(), best_model_file)

    model_file = "models/3_googlenet_pretrained__model_" + str(epoch) + ".pth"
...
# save results
with open("history_3_googlenet_pretrained.pkl", "wb") as fout:
